...
<script>
    $(document).ready(function() {
        ...
        var table = $('#newsTable').DataTable({
            ...
            "ajax": function(data, callback, settings) {
                axios.get('https://clinet-server-indriyunimasi.000webhostapp.com/listnews.php',{
                    params: {
    ...
    function deleteNews(id) {
        ...
        if (confirm("Are you sure you wznt to deleteht this news?")) {
            axios.post('https://clinet-server-indriyunimasi.000webhostapp.com/deletenews.php', formData)
            .then(function(response) {
                alert(response.data);
